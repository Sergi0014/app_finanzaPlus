...
class AppTheme {
  ...
  static const Color primaryColor = Color(0xFF6366F1); // Índigo vibrante
  ...
  static const Color expenseColor = Color(0xFFEF4444); // Rojo vibrante
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: textTertiaryColor.withValues(alpha: 0.3)),
      ),
